...
from src.data.utils.lowpoly_utils import get_lowpoly_human
...
OBJECT_TRANSFORMS_SOLIDIFY_THICKNESS_MIN = -0.1
OBJECT_TRANSFORMS_SOLIDIFY_THICKNESS_MAX = 0.5

OBJECT_TRANSFORMS_SIMPLE_DEFORM_ANGLE_MIN = -0.3
OBJECT_TRANSFORMS_SIMPLE_DEFORM_ANGLE_MAX = 0.3

OBJECT_TRANSFORMS_RANDOMIZE_FACTOR_MIN = -0.4
OBJECT_TRANSFORMS_RANDOMIZE_FACTOR_MAX = 0.4
