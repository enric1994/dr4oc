...
penguin_path = '/datasets/penguin_lowpoly/penguin.obj'
...
OBJECT_SCALE_MIN = 0.4
OBJECT_SCALE_MAX = 0.4#0.2
...
OBJECT_TRANSFORMS_SOLIDIFY_THICKNESS_MIN = -0.05
OBJECT_TRANSFORMS_SOLIDIFY_THICKNESS_MAX = 0.3

OBJECT_TRANSFORMS_SIMPLE_DEFORM_ANGLE_MIN = -0.3
OBJECT_TRANSFORMS_SIMPLE_DEFORM_ANGLE_MAX = 0.3

OBJECT_TRANSFORMS_RANDOMIZE_FACTOR_MIN = -0.3
OBJECT_TRANSFORMS_RANDOMIZE_FACTOR_MAX = 0.3
