...
OBJECT_SCALE_MIN = 20
OBJECT_SCALE_MAX = 20#0.2

OBJECT_TRANSFORMS = ['SOLIDIFY'] #['CAST', 'SOLIDIFY', 'SIMPLE_DEFORM', 'RANDOMIZE']
OBJECT_TRANSFORMS_MIN = 1
OBJECT_TRANSFORMS_MAX = 1

OBJECT_TRANSFORMS_CAST_FACTOR_MIN = -0.4
OBJECT_TRANSFORMS_CAST_FACTOR_MAX = 0.3
OBJECT_TRANSFORMS_CAST_TYPES = ['SPHERE', 'CUBOID']

OBJECT_TRANSFORMS_SOLIDIFY_THICKNESS_MIN = -1 #-0.18
OBJECT_TRANSFORMS_SOLIDIFY_THICKNESS_MAX = 3 #0.4

OBJECT_TRANSFORMS_SIMPLE_DEFORM_ANGLE_MIN = -0.3
OBJECT_TRANSFORMS_SIMPLE_DEFORM_ANGLE_MAX = 0.3

OBJECT_TRANSFORMS_RANDOMIZE_FACTOR_MIN = -0.9
OBJECT_TRANSFORMS_RANDOMIZE_FACTOR_MAX = 0.9
...
def generate_input(image_id, objects_number):
    ...
    base_size = math.sqrt(1+abs(objects_number))*random.uniform(OBJECT_SCALE_MIN, OBJECT_SCALE_MAX)
    ...
    for o, xy in enumerate(X):
        rand_object_path = get_random_lowpoly_vehicle()
