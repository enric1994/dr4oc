...
elif args.dataset.lower() == 'blendercam':
    from src.preprocess.preprocess_dataset_blendercam import main

    main(args.input_dataset_path, args.output_dataset_path, 512, 2048)

elif args.dataset.lower() == 'citycam':
    from src.preprocess.preprocess_dataset_citycam import main
